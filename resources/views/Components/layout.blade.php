    ...
    <nav class="bg-gray-800">
            ...
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" href="/"
                ...
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        <button
                            ...
                            <svg class="size-6" data-slot="icon" aria-hidden="true" fill="none" viewBox="0 0 24 24"
                ...
                <div class="-mr-2 flex md:hidden">
                    ...
                    <button
                        ...
                        <svg class="block size-6" data-slot="icon" aria-hidden="true" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="md:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <a class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" href="/"
                    aria-current="page">Home</a>
